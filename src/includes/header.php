...
<head>
    ...
    <link rel="preload" as="style" href="/assets/css/style.min.css?v=<?php echo h($cssVersion); ?>">
    ...
    <link rel="stylesheet" href="/assets/css/style.min.css?v=<?php echo h($cssVersion); ?>">
</head>
...
<body>
    ...
    <header class="site-header">
        <div class="header-topline">
            <p>Edition numerique &mdash; Dossier geopolitique &middot; <?php echo date('d/m/Y'); ?></p>
        </div>
